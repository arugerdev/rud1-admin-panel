  ...
  return (
    <html lang="en" className="h-screen w-screen">
      ...
      >
        <Toaster />
        {children}
        <footer className="hidden md:absolute mt-4 bottom-0 w-full text-center text-xs p-2 flex flex-row gap-8">
          <a href="https://dashboard.rud1.es" className="w-full text-[#55A] font-bold text-md">www.rud1.es</a>
          <small className="whitespace-nowrap">Version 1.1 2025 - Rud1</small>
        </footer>
      </body>
    </html>
  );
